...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void deleteAllPets() {
        ...
        if (rowsDeleted > 0) {
            Toast.makeText(this, getResources().getString(R.string.pets_deleted_successful), Toast.LENGTH_SHORT);
        } else
            Toast.makeText(this, getResources().getString(R.string.pets_deleted_failed), Toast.LENGTH_SHORT);
    }
